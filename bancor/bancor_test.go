...
func TestBancor_Buy(t *testing.T) {
	bancor1 := NewBancor(500000, 1, 1, 1e8, "", "1", 0, 0)
	bancor2 := NewBancor(500000, 1, 1, 1e8, "", "1", 0, 0)
...
func TestBancor_Buy2(t *testing.T) {
	...
	bancor2 := NewBancor(500000, 1e8, 1, 1e8, "", "1", 0, 0)
	amount2 := bancor2.Buy(1e5 * 1e8)
	fmt.Println(amount2)
}

func TestBancor_Sell(t *testing.T) {
	bancor := NewBancor(500000, 1, 1, 1e8, "", "1", 0, 0)
...
func TestBancor_Sell2(t *testing.T) {
	bancor := NewBancor(500000, 250, 1000, 1e8, "", "1", 0, 0)
